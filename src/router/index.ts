...
router
  ...
  .use(`/${routes.editProfileData}`, ProfilePage, { isViewProfile: false, profileType: editProfilePage.editProfileData })
  .use(`/${routes.editProfilePassword}`, ProfilePage, { isViewProfile: false, profileType: editProfilePage.editProfilePassword })
  .use(`/${routes.serviceUnavailable}`, ErrorPage, { scheme: getErrorScheme(routes.serviceUnavailable) })
